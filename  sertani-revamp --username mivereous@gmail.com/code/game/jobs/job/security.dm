/datum/job/hos
	...
	access = list(access_security, access_sec_doors, access_brig, access_armory, access_court,
			            ...
			            access_heads, access_hos, access_RC_announce, access_keycard_auth, access_gateway,access_reporter, access_protector)
...
/datum/job/officer
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(prob(33))
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/security3(H), slot_w_uniform)
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/jackboots(H), slot_shoes)
...
/datum/job/protector
		...
		access = list(access_security, access_sec_doors, access_brig, access_court,
				        		    ...
				        		    access_research, access_engine, access_mining, access_medical, access_construction, access_mailsorting,
				     				access_heads, access_hos, access_keycard_auth, access_gateway, access_protector)
		minimal_access = list(access_security, access_sec_doors, access_brig, access_armory, access_court,
						            access_forensics_lockers, access_morgue, access_maint_tunnels, access_all_personal_lockers,
						            access_research, access_engine, access_mining, access_medical, access_construction, access_mailsorting,
						            access_heads, access_hos, access_RC_announce, access_keycard_auth, access_gateway, access_protector)
		minimal_player_age = 14

/datum/job/captain
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "Saris Industries officials and Space law"
...
/datum/job/hop
	...
	access = list(access_security, access_sec_doors, access_brig, access_court, access_forensics_lockers,
			            ...
			            access_clown, access_mime, access_hop, access_RC_announce, access_keycard_auth,access_reporter, access_gateway)

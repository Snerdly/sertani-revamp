...
/datum/game_mode/blob/send_intercept(var/report = 1)
	...
	switch(report)
		if(1)
			...
			intercepttext += "<FONT size = 3><B>Saris Industries Update</B>: Biohazard Alert.</FONT><HR>"
			...
			intercepttext += "Saris Industries has issued a directive 7-10 for [station_name()]. The station is to be considered quarantined.<BR>"

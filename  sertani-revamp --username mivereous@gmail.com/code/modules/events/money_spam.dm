	...
	if(useMS)
		...
		if(prob(2))
			...
			switch(pick(1,2,3,4,5,6,7))
				...
				if(6)
					sender = pick("Saris Industries Morale Divison","Feeling Lonely?","Bored?","www.wetskrell.nt")
					message = pick("The Saris Industries Morale Division wishes to provide you with quality entertainment sites.",\
					...
					"Wetskrell.nt only provides the higest quality of male entertaiment to Saris Industries Employees.",\
					"Simply enter your Saris Industries Bank account system number and pin. With three easy steps this service could be yours!")
				if(7)

...
var/list/SKILL_HOS = list("field" = "Security", "command" = SKILL_ADEPT, "combat" = SKILL_ADEPT, "weapons" = SKILL_ADEPT, "law" = SKILL_EXPERT, "forensics" = SKILL_BASIC)
var/global/list/SKILL_PRE = list("Engineer" = SKILL_ENGINEER, "Roboticist" = SKILL_ORGAN_ROBOTICIST, "Security Officer" = SKILL_SECURITY_OFFICER, "Chemist" = SKILL_CHEMIST, "Head of Security" = SKILL_HOS)
...
datum/skill/knowledge/law
    ID = "law"
    name = "Saris Industries Law"
    desc = "Your knowledge of Saris Industries law and procedures. This includes Space Law, as well as general station rulings and procedures. A low level in this skill is typical for security officers, a high level in this skill is typical for captains."
    field = "Security"
    secondary = 1

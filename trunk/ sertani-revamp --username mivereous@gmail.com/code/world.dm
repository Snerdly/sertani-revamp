...
#define INACTIVITY_KICK	12000	//20 minutes in ticks (approx.)
...
/world/proc/update_status()
	...
	s += "<b>[station_name()]</b>";
	s += " ("
	s += "<a href=\"http://sertani.webs.com\">" //Change this to wherever you want the hub to link to.
//	s += "[game_version]"
	s += "RolePlay Server"  //Replace this with something else. Or ever better, delete it and uncomment the game version.
	s += "</a>"
	s += ")"

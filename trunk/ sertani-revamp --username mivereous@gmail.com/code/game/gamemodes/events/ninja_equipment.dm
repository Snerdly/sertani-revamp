	...
	switch(spideros)
		...
		if(4)
			dat += {"
					...
					<ul>
					<li>*<b>Saris Industries</b> and the Syndicate are two sides of the same coin and that coin is valuable.</li>
					...
					Space ninjas are renowned throughout the known controlled space as fearless spies, infiltrators, and assassins. They are sent on missions of varying nature by Saris Industries, the Syndicate, and other shady organizations and people. To hire a space ninja means serious business.

...
//big pile of shit below.
	...
	dat = {"<html>
				...
				<li>Install the internal armor plating (Not included due to Saris Industries regulations. Can be made using 5 metal sheets.)</li>
				<li>Secure the internal armor plating with a wrench</li>
				<li>Weld the internal armor plating to the chassis</li>
				<li>Install the external reinforced armor plating (Not included due to Saris Industries regulations. Can be made using 5 reinforced metal sheets.)</li>
				...
				<li>Saris Industries is determined to the safety of its <s>investments</s> employees.</li>
				</ol>
				</body>
				</html>
...
/obj/item/weapon/book/manual/robotics_cyborgs
	...
	dat = {"<html>
        ...
        h3 {font-size: 15px; margin: 15px 0px 5px;}
				...
				This useful piece of equipment can be used to immobolize or destroy a cyborg. A word of warning: Cyborgs are expensive pieces of equipment, do not destroy them without good reason, or Saris Industries may see to it that it never happens again.
        ...
        <h3>WARNING:</h3> Do not detonate a borg without an explicit reason for doing so. Cyborgs are expensive pieces of Saris Industries equipment, and you may be punished for detonating them without reason.
...
/obj/item/weapon/book/manual/security_space_law
	name = "Space Law"
	desc = "A set of Saris Industries guidelines for keeping law and order on their space stations."
	icon_state = "bookSpaceLaw"
	author = "Saris Industries"
	title = "Space Law"
	dat = {"

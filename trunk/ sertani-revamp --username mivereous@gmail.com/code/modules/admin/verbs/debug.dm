...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in mob_list)
	...
	switch(dresscode)
		...
		if("nanotrasen representative")
			...
			var/obj/item/device/pda/heads/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "Saris Industries Navy Representative"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
			...
			W.assignment = "Saris Industries Navy Representative"
			W.registered_name = M.real_name
		...
		if("nanotrasen officer")
			...
			var/obj/item/device/pda/heads/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "Saris Industries Navy Officer"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
			...
			W.assignment = "Saris Industries Navy Officer"
			W.registered_name = M.real_name
			M.equip_if_possible(W, slot_wear_id)
		...
		if("nanotrasen captain")
			...
			var/obj/item/device/pda/heads/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "Saris Industries Navy Captain"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "Saris Industries Navy Captain"
			W.registered_name = M.real_name
			M.equip_if_possible(W, slot_wear_id)
		...
		if("serveris")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/forensics/fluff/mazratech(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/diamondback(M), slot_belt)

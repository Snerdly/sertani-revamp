...
/obj/item/weapon/paper/runtime
	name = "paper-Memo"
	info = "Dear valued medical officer,<BR><BR>Your cat has been moved to your apartment in the command sector due to security reasons. We apologize for any inconvenience.<BR>Sincerly,<BR>Saris Industries Supply & Management Department"

/obj/item/weapon/paper/ian
	name = "paper- Memo"
